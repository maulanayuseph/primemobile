				...
				<div class="content">
					<div class="row">
						<div class="col-sm-126">
							<form method="post" action="<?php echo base_url('pg_admin/qc_user/proses_tambah');?>">
								<table class="table">
									<tr>
										<td>Nama</td>
										<td>:</td>
										<td>
											<input type="text" name="nama" class="form-control" placeholder="Masukkan Nama QC" required>
										</td>
									</tr>
									<tr>
										<td>Username</td>
									...
									<tr>
										...
										<td>:</td>
										<td>
											<input type="password" name="repassword" class="form-control" placeholder="Masukkan ualng password" required>
										</td>
									</tr>
									<tr>
										<td colspan="3" style="text-align: right;">
											<a href="<?php echo base_url("pg_admin/qc_user");?>" class="btn btn-sm btn-danger">Kembali</a>
											<input type="submit" name="submit" class="btn btn-sm btn-danger" value="Register User QC">
										</td>
									</tr>
								</table>
							</form>
