  ...
  <div class="panel-heading" role="tab" id="headingOne">
    <div class="row">
      ...
      <div class="col-sm-6" style="text-align: right;">
        <button class="btn btn-sm btn-primary tambah-sub-tema" id="tambah-sub-<?php echo $tema->id_tema;?>" data-toggle="modal" data-target="#mainmodal">
          <i class="fa fa-plus" aria-hidden="true"></i>
        </button>

        <button class="btn btn-sm btn-warning edit-tema" id="edit-tema-<?php echo $tema->id_tema;?>" data-toggle="modal" data-target="#mainmodal"><i class="fa fa-pencil" aria-hidden="true"></i></button>
                ...
                foreach($datasub as $sub){
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <button class="btn btn-sm btn-warning edit-sub-tema" id="edit-syb-<?php echo $sub->id_sub_tema;?>" data-toggle="modal" data-target="#mainmodal"><i class="fa fa-pencil" aria-hidden="true"></i></button>
...
$(function(){
  $(".edit-tema").click(function(){
    ...
    idsplit = rawid.split("-");
    idtema  = idsplit[2];
    $("#mainmodaltitle").html("Edit Tema");
    $("#mainmodalcontent").load("manajemen_tema/edit/" + idtema);
  })
  $(".hapus-tema").click(function(){
    if(confirm("Apakah anda yakin untuk menghapus tema ?")){
      ...
      $.ajax({
        type: 'POST',
        url: 'manajemen_tema/proses_hapus',
        data:{
          'idtema'  : idtema
        }
      });
  ...
  $(".tambah-sub-tema").click(function(){
    ...
    idsplit = rawid.split("-");
    idtema  = idsplit[2];
    $("#mainmodaltitle").html("Tambah Sub Tema");
    $("#mainmodalcontent").load("manajemen_tema/tambah_sub_tema/" + idtema);
  ...
  $(".edit-sub-tema").click(function(){
    ...
    idsplit = rawid.split("-");
    idsub  = idsplit[2];
    $("#mainmodaltitle").html("Edit Sub Tema");
    $("#mainmodalcontent").load("manajemen_tema/edit_sub_tema/" + idsub);
  ...
  $(".hapus-sub-tema").click(function(){
    ...
    if(confirm("Apakah anda yakin untuk menghapus sub tema ?")){
      $.ajax({
        type: 'POST',
        url: 'manajemen_tema/proses_hapus_sub_tema',
        data:{
          'idsub'  : idsub
        }
      });
