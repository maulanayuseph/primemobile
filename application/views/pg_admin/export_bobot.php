              ...
              <div class="content">
				<div class="table-responsive">
					<table class="table table-stripped">
						<form action="<?php echo base_url("pg_admin/materi/export_bobot");?>" method="post">
							<tr>
								<td>
							...
							<tr>
								<td>
									<select id="tipe" class="form-control" name="tipe" required>
										<option value="subbab">Sub-Bab</option>
							...
							<tr>
								<td style="text-align: right;">
									<input type="submit" class="btn btn-sm btn-primary" value="Export Excel"/>
								</td>
							</tr>
						</form>
					</table>
