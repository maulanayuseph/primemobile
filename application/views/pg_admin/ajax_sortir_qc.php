...
<tr>
  ...
  <td class="text-center">
	<div class="button-group">
		...
		<button class="btn btn-xs btn-primary lihat-soal" id="lihat-<?php echo $item->id_soal;?>" data-toggle="modal" data-target="#modalsoal"><i class="glyphicon glyphicon-eye-open"></i></button>
