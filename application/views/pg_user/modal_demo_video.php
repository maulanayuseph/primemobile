...
<div id="videoDemoModal" class='modal fade modal-center' role="dialog" tab-index='-1' aria-hidden='true' aria-labelledby="gridSystemModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">        
        ...
        <h4 class="modal-title" id="video_demo_label"><i class="glyphicon glyphicon-play-circle "></i> Video Demo</h4>
      </div>
      <div class="modal-body">
        <div class="container-fluid">
          
          <div id="konten_video_demo">
