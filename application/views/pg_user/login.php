	...
	<body>
		...
		<div class="page-body login" style="margin-top: 60px;">
            ...
            <div class="app-wrapper">
              <div class="left">
                <h4>Take Prime on the go!</h4>
                <p>Download Prime mobile apps for iOS and Android to keep
                    your skill sharp when on the go.</p>
                <p class="link"><a href="">App Store</a>   <a href="">Play Store</a></p>
              </div>
              <img class="right" src="<?php echo base_url('assets/pg_user/images/custom/hp.png');?>">
            </div>
            -->
						<!-- /Ibnu -->
					</div>
