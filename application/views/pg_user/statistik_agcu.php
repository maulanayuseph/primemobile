      ...
      <div class="nilai-wrapper">
        ...
        <div class="nilai-container">
          ...
          <div class="nilai-images">
            <div class="top">
              <div class="ranking">Ranking Kelas <br/><span><?php echo !empty($rankkelas) ? ($r+1) : 0 ?> dari <?php echo count($rankkelas)?> Siswa</td></span></div>
              <img class="grafik" src="<?php echo base_url('assets/dashboard/images/grafik.jpg');?>">
            </div>
            <div class="bottom">
              <h6>PREDIKAT</h6>
              ...
              <!-- <img class="diagram" src="<?php //echo base_url('assets/dashboard/images/diagram.png');?>"> -->
            </div>
          </div>
        </div>
