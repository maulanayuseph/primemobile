								...
								<div id="item_soal_<?php echo $no;?>" class="tab-pane fade">
									...
									<div class="row equal-row item-soal">
										...
										<div class="col-sm-4 equal-col soal">
												...
												<br><?php echo $item->pembahasan_teks ? html_entity_decode($item->pembahasan_teks) : '';?>
										...
										<div class="col-sm-8 equal-col jawaban">
											...
											<div class="row" >
												...
												<div class="col-md-12">
													...
													?>
													<a class="btn btn-info" id="pembahasan-<?php echo $no;?>" data-toggle="modal" data-target="#pembahasanVideoModal">Pembahasan Video<i class="glyphicon glyphicon-chevron-right"></i></a>
													<?php
													}
													?>
													<?php
													...
													?>
													<a class="btn btn-info" id="pembahasan_teks<?php echo $no;?>" data-toggle="modal" data-target="#bahasteks<?php echo $no;?>">Pembahasan Teks<i class="glyphicon glyphicon-chevron-right"></i></a>
													<?php
													}
													?>
												</div>
