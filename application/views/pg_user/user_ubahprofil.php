    ...
    <div class="container-fluid akun-container">
        ...
        <div class="row row-login well">
			...
			if(isset($_GET['action'])){
				if($_GET['action'] == "kurikulum"){
					?>
					<input type="hidden" id="aksi-kurikulum" value="<?php echo $_GET['action'];?>" />
					<?php
				}
			}else{
				?>
				<input type="hidden" id="aksi-kurikulum" value="none" />
				<?php
			}
			?>
          <div class="col-sm-3">
							...
							<form action="<?php echo base_url("user/proses_edit_sekolah");?>" method="post" class="edit-profile-form" style="padding:10px 0px;">
								<div class="form-group">
								  ...
								  <select name="provinsi" class="form-control" id="pilihprovinsi">
								  	<?php
								  		if($infosekolah->id_provinsi !== null){
								  			?>
								  			<option value="<?php echo $infosekolah->id_provinsi;?>"><?php echo $infosekolah->nama_provinsi;?></option>
								  			<?php
								  		}else{
								  			?>
								...
								<div class="form-group">
								  ...
								  <select name="kota" class="form-control" id="pilihkota">
								  	<?php
								  		if($infosekolah->id_kota !== null){
								  			?>
								  			<option value="<?php echo $infosekolah->id_kota;?>"><?php echo $infosekolah->nama_kota;?></option>
								  			<?php
								  		}else{
								  			?>
								...
								<div class="form-group">
								  <div class="label-style" style="width: auto;">Nama Sekolah</div>
								  ...
								  <div class="input-group" style="width: 100%;">
									...
									<div id="sekolah">
										...
										<?php
									  		if($infosekolah->id_sekolah !== null){
									  			?>
									  			<option value="<?php echo $infosekolah->id_sekolah;?>"><?php echo $infosekolah->nama_sekolah;?></option>
									  			<?php
									  		}else{
									  			?>
								 ...
								 <div class="form-group">
									...
									<select name="kelas" id="kelassekolah" class="form-control" style="width: 100%;">
										<?php
											if($infosiswa->kelas !== 0){
												?>
												<option value="<?php echo $infosiswa->kelas;?>"><?php echo $infosiswa->alias_kelas;?></option>
												<?php
											}
										?>
									</select>
								 ...
								 <div class="form-group">
									<div class="label-style" style="width: auto;">Kurikulum</div>
									<select name="kurikulum" class="form-control" style="width: 100%;">
										<?php
											$k1 = "";
											$k2 = "";
											$k3 = "";
											if($infosiswa->kurikulum !== ""){
												if($infosiswa->kurikulum == "K-13"){
													$k1 = "selected";
												}elseif($infosiswa->kurikulum == "K-13 REVISI"){
													$k2 = "selected";
												}elseif($infosiswa->kurikulum == "KTSP"){
													$k3 = "selected";
												}else{
													$k1 = "";
													$k2 = "";
										...
										?>
										<option value="K-13" <?php echo $k1;?>>K-13</option>
										<option value="K-13 REVISI" <?php echo $k2;?>>K-13 REVISI</option>
										<option value="KTSP" <?php echo $k3;?>>KTSP</option>
									</select>
								 </div>
								 <div class="form-group">
									<p>&nbsp;
            ...
            <div id="ubah_akun_fb" class="col-sm-9 tab-pane fade">
              <div>
                ...
                <div id="unlinkFbAccount" style="display: <?php echo $fb_status ? 'block' : 'none'?>">
                  ...
                  <br>
                  <div class="btn btn-info btn-block" id="buttonFbUnlink" onclick="_logout();" style="word-wrap:normal;">
                ...
                <div id="linkFbAccount" style="display: <?php echo $fb_status ? 'none' : 'block'?>">
                  ...
                  <br>
                  <div class="btn btn-primary btn-block" id="buttonFblink" onclick="_login();" style="word-wrap:break-word;">
                    <span class="glyphicon glyphicon-log-in"></span>Hubungkan akunku dengan akun Facebook
                  </div>
                </div>
              </div>
            </div>
...
//            }
    ...
    <script type="text/javascript">
      $(document).ready(function() {
      	aksi = $("#aksi-kurikulum").val();
      	if(aksi === "kurikulum"){
      		$('a[href="#tabsekolah"]').tab('show');
      	}
