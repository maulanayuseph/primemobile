...
<html lang="en">
    ...
    <body>
		...
		<section class="page">
			<!-- apa kata -->
			<div class="container">
				<h3 class="page-title text-center"><span class="text-danger">Batas Pembayaran Telah Habis</span></h3>
				<p class="text-center" style="margin-bottom:3em"><strong>Silakan ulangi proses pembelian paket <a href="<?php echo base_url() ?>user/paket">disini</a></strong></p>
