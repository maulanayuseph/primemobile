	...
	<div class="col-sm-6">
		<div class="card">
			<div class="col-sm-12 card text-center">
				<h4>Kamu belum melakukan konfirmasi pembelian aktivasi event, segera lakukan konfirmasi untuk mendapatkan aktivasi sebelum event dimulai</h4>
				<br>
				<a href="<?php echo base_url("user/bayar/" . $pembelian->id_pembelian);?>" class="btn btn-danger" style="width: 100%;">Konfirmasi Pembelian Aktivasi</a>
				<br>&nbsp;
			</div>
		</div>
	</div>
