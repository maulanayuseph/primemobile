...
<html lang="en">
	...
	<head>
		...
		<title>Simulasi SBMPTN | Prime Mobile - Cara belajar masa kini</title>
    ...
    <?php include "modal_pembahasan.php"; ?>
		...
		<div class="page-body latihan-soal">
			<form id="form_soal" method="post" action="<?php echo base_url('sbmptn/penilaian')?>">
			<div class="soal-header">

				<h2>Simulasi SBMPTN</h2>
				...
				<ul class="keterangan">
					...
					<li><button class="btn btn-danger" type="submit" name="submit_form_soal" value="submit" onclick="return confirm('Apakah anda yakin untuk mengakhiri tes?')">Akhiri Tes</button></li>
				</ul></div>
			</div>
					...
					<div class="container">
						...
						<textarea id="stopwatch" name="lamapengerjaan" style="display: none;"></textarea>
							<div class="row">
								...
								<button style="display:none;" type="submit" name="submit_form_soal" id="submit_form_soal" value="submit" onclick="return confirm('Apakah anda yakin untuk mengakhiri tes?')">SUBMIT</button>
