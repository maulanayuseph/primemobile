...
<html lang="en">
    ...
    <body>
		...
		<section class="page">
			<!-- apa kata -->
			<div class="container">
			    <h3>Rincian Transaksi Pembayaran</h3>
			    <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td>Tanggal/Waktu</td>
                                <td>: 2016-08-11 11:09:41 WIB</td>
                            </tr>
                            <tr>
                                <td>Pemesan</td>
                                <td>: Budi - budi@anduk.com</td>
                            </tr>
                            <tr>
                                <td>Status</td>
                                <td>: <label class="label label-danger">Dibatalkan</label></td>
                            </tr>
                            <tr>
                                <td>Metode Bayar</td>
                                <td>: Transfer</td>
                ...
                <a href="#" class="btn btn-default"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Cetak</a>
			</div>				
		</section>
