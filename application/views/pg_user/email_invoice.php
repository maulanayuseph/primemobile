							...
							<div class="body-text">
								...
								<table border="0" width="100%" height="100%" cellpadding="5" cellspacing="0">
								  ...
								  <tr>
									...
									<td>: <label style="color:blue"><b><?php echo date('d/m/Y, H:i:s', strtotime($buy->expired_on));?></b></label></td>
								  </tr>
								</table><br><br>
								...
								<table border="1" width="100%" height="100%" cellpadding="5" cellspacing="0">
								  ...
								  <tr>
									...
									<?php
										if($item->tipe == 0){
											echo "Reguler " . $item->durasi . " Bulan";
										}elseif($item->tipe == 1){
											echo "Premium  " . $item->durasi . " Bulan";
										}elseif($item->tipe == 4){
											echo "Event";
										}
									?>
								...
								<center><h4>Daftar Nomor Rekening untuk Transfer Pembayaran</h4></center>
								<table border="0" width="100%" height="100%" cellpadding="5" cellspacing="0">
									<!--
									<tr>
									 <td align="center">
									...
									<tr>
									 <td align="center">
										...
										<p>
										BANK MANDIRI<br>
										A.n. PT. Prima Generasi Bimbingan Belajar<br>
