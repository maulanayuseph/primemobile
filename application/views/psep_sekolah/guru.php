      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="header">
                <h4 class="title">Data Guru <?php echo $sekolah->nama_sekolah;?></h4>
              </div>
              <div class="content">
                <div class="row">
                  <div class="col-md-12">
					<a href="<?php echo base_url("psep_sekolah/guru/tambah");?>" class="btn btn-primary">Register Guru</a>
					<br>&nbsp;
					<br>&nbsp;
							...
							?>
								<tr>
									...
									<td>
										<?php
											if($guru->status == 0){
												echo "Menunggu Verifikasi Prime Mobile";
