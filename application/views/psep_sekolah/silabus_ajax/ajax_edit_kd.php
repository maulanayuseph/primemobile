<div class="row">
	<div class="col-sm-6">
		<select class="form-control" id="kelas-tambah-kd">
			<option value="<?php echo $kd->id_kelas;?>"><?php echo $kd->alias_kelas;?></option>
			<?php
	...
	<div class="col-sm-6">
		<select class="form-control" id="mapel-tambah-kd">
			<option value='<?php echo $kd->id_psep_mapel;?>'><?php echo $kd->nama_psep_mapel;?></option>
		</select>
	</div>
	<div class="col-sm-12">
		&nbsp;
	...
	<div class="col-sm-6">
		<select class="form-control" id="tahun-ajaran-tambah-kd">
			<option value='<?php echo $kd->id_tahun_ajaran;?>'><?php echo $kd->tahun_ajaran;?></option>
			<?php
	...
	<div class="col-sm-6">
		<select class="form-control" id="semester-tambah-kd">
			<option value='<?php echo $kd->semester;?>'>Semester <?php echo $kd->semester;?></option>
			<?php
				if($jenjang == "SD"){
					?>
	...
	<div class="col-sm-2">
		<select class="form-control" id="ki">
			<option value="<?php echo $kd->ki;?>"><?php echo $kd->ki;?></option>
	...
	<div class="col-sm-2">
		<select class="form-control" id="kd">
			<option value="<?php echo $kd->no_kd;?>"><?php echo $kd->no_kd;?></option>
			<?php
				for($i = 1; $i <= 10; $i++){
					?>
	...
	<div class="col-sm-8">
		<textarea class="form-control" id="deskripsi-kd" placeholder="Masukkan deskripsi KD"><?php echo $kd->kompetensi_dasar;?></textarea>
	</div>
	<div class="col-sm-12">
		&nbsp;
	</div>
...
$(function(){
	...
	$("#simpan-kd").click(function(){
		...
		if(mapel === 0 || tahunajaran === 0 || semester === 0 || ki === 0 || kd === 0 || deskripsi === ""){
			...
			$.ajax({
				type: 'POST',
				url: 'silabus/ajax_proses_edit_kd',
				data:{
					'idkd'			: idkd,
					'mapel'			: mapel,
