              ...
              <div class="content">
                <div class="row">
					<div class="col-md-12">
						...
						<input type="hidden" name="idintrosoal" value="<?php echo $intro->id_intro_soal;?>" />
						<label>Pendahuluan Soal<span class="text-danger">*</span></label>
						<textarea class="tinymce_textarea" name="intro"><?php echo $intro->intro_soal;?>
						</textarea>
						<input type="submit" value="Simpan pendahuluan" class="btn btn-primary"/>
						</form>
					</div>
                </div>
