        ...
        <div class="row">
		  ...
		  <div class="col-md-12">
		  	<div class="card">
	            ...
	            <div class="content">
	                <div class="row">
	                	<form method="post" action="<?php echo base_url("psep_sekolah/bank_soal/proses_tambah_soal");?>">
		                	<div class="col-sm-4">
		                	...
		                	<div class="col-sm-12">
		                		<br>
		                		<input type="submit" name="submit" class="btn btn-sm btn-danger" value="Tambah Soal">
		                	</div>
	                	</form>
	                </div>
	            </div>
