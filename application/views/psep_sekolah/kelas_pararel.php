						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="<?php echo base_url("psep_sekolah/kelas_paralel/hapus/".$kelas->id_kelas_paralel);?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus <?php echo $kelas->kelas_paralel;?> ? semua siswa yang terdaftar di kelas paralel yang bersangkutan')">
