...
$config['usertracking']['tracking_filter'][] = array("helper", "user_tracking_helper", "is_logged_in", TRUE);
// $config['usertracking']['tracking_filter'][] = array("model", "model_security_user", "is_logged_in", TRUE);
